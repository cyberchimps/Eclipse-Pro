			...
			<div id="twittertext">
				<?php
					if ( $latest_tweet ) {	
						...
						echo '<a href="'.$user_permalink.'"> '. $screen_name .' - </a>'.$tweet_text.' <small><a href="'.$tweet_permalink.'">' .human_time_diff(strtotime($latest_tweet['created_at']), current_time('timestamp', 1)).' ago</a></small>';
					} else {
